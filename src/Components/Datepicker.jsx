...
function Datepicker({
  ...
  return (
    <div className="relative">
      <Flatpickr className="form-input pl-10 dark:bg-slate-800 text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-200 font-medium w-[15.5rem]" options={options} />
